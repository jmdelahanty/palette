...
recording that already has detections/crops/refined keypoints:
  ...
  refined_keypoints -> track_kinematics -> swim_bout_runs -> stimulus_response
...
Options:
  ...
  --overwrite                     Pass --overwrite to swim-bout detection when
                                  a fixed --bout-run already exists.
  ...
  --track-run RUN                 Output offline track_kinematics run.
                                  Default: tk_hyst4_low2_s005
  --bout-run RUN                  Output swim_bout_runs name.
                                  Default: bouts_tk_hyst4_low2_s005_filtered_thr0p01
  --stimulus-response-run RUN     Output stimulus_response_runs name.
                                  Default: stimulus_response_tk_hyst4_low2_s005_grating_canary
  ...
  --camera-to-projector-offset-deg DEG
                                  Stimulus angular offset. Default: 0.0.
...
TRACK_RUN="tk_hyst4_low2_s005"
BOUT_RUN="bouts_tk_hyst4_low2_s005_filtered_thr0p01"
STIMULUS_RESPONSE_RUN="stimulus_response_tk_hyst4_low2_s005_grating_canary"
TRACK_ID=0
