...
def test_write_reason_arrays_creates_only_canonical_reason_bytes(tmp_path) -> None:
    ...
    assert refined.attrs["reason_authority"] == "reason_bytes"
    assert refined.attrs["reason_fallback_order"] == ["reason_bytes", "detection_source"]
