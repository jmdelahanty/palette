...
- [ ] Implement and independently review dedicated typed runners for the
    ...
    - [ ] Implement the remaining two typed family runners: detection occupancy
          and session occupancy. Their array/storage contracts are already
          exact; the remaining blocker is an invocation-bound spatial and
          temporal source-authority identity that cannot be swapped between
          request construction and child execution.
