...
| `--keypoint-roi-shard-rows` | `131072` | Outer rows for indexed-sharded ROI-domain arrays |
| `--keypoint-frame-shard-rows` | `131072` | Outer rows for indexed-sharded frame-domain arrays |
