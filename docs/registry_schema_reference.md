...
> Generated at: `2026-08-10T04:35:32Z`
...
| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `experimental_session_id` | `TEXT` | no | yes | `` |
| `session_snapshot_id` | `TEXT` | no | no | `` |
| `schema_id` | `TEXT` | no | no | `` |
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_experimental_sessions_2` | yes | `u` | no | `session_snapshot_id` |
| `sqlite_autoindex_experimental_sessions_1` | yes | `pk` | no | `experimental_session_id` |
...
### `recording_experimental_session_assignments`

| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `assignment_snapshot_id` | `TEXT` | no | yes | `` |
| `recording_id` | `TEXT` | no | no | `` |
| `experimental_session_id` | `TEXT` | no | no | `` |
...
```sql
CREATE TABLE recording_experimental_session_assignments (
...
| FK ID | From | To | On Update | On Delete | Match |
|---|---|---|---|---|---|
| `0` | `recording_id` | `recording_experimental_session_assignments.recording_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `supersedes_assignment_snapshot_id` | `recording_experimental_session_assignments.assignment_snapshot_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `experimental_session_id` | `experimental_sessions.experimental_session_id` | `NO ACTION` | `RESTRICT` | `NONE` |
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `idx_recording_experimental_session_assignments_batch` | no | `c` | no | `assignment_batch_id`, `recording_id` |
| `idx_recording_experimental_session_assignments_session` | no | `c` | no | `experimental_session_id`, `recording_id`, `assignment_revision` |
| `sqlite_autoindex_recording_experimental_session_assignments_4` | yes | `u` | no | `recording_id`, `assignment_snapshot_id` |
| `sqlite_autoindex_recording_experimental_session_assignments_3` | yes | `u` | no | `recording_id`, `assignment_revision` |
| `sqlite_autoindex_recording_experimental_session_assignments_2` | yes | `u` | no | `supersedes_assignment_snapshot_id` |
| `sqlite_autoindex_recording_experimental_session_assignments_1` | yes | `pk` | no | `assignment_snapshot_id` |

### `recording_experimental_session_current`
...
```sql
CREATE TABLE recording_experimental_session_current (
...
|---|---|---|---|---|---|
| `0` | `recording_id` | `recording_experimental_session_assignments.recording_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `assignment_snapshot_id` | `recording_experimental_session_assignments.assignment_snapshot_id` | `NO ACTION` | `RESTRICT` | `NONE` |
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_recording_experimental_session_current_2` | yes | `u` | no | `assignment_snapshot_id` |
| `sqlite_autoindex_recording_experimental_session_current_1` | yes | `pk` | no | `recording_id` |
...
| `recording_id` | `TEXT` | yes | no | `` |
| `session_uuid` | `TEXT` | yes | no | `` |
| `experimental_session_id` | `TEXT` | yes | no | `` |
| `experimental_session_snapshot_id` | `TEXT` | yes | no | `` |
| `experimental_session_schema_id` | `TEXT` | yes | no | `` |
| `experimental_session_creation_method` | `TEXT` | yes | no | `` |
| `experimental_session_created_by` | `TEXT` | yes | no | `` |
| `experimental_session_created_at_utc` | `TEXT` | yes | no | `` |
| `experimental_session_creation_evidence_json` | `TEXT` | yes | no | `` |
| `experimental_session_creation_registry_schema_version` | `INTEGER` | yes | no | `` |
| `experimental_session_identity_status` | `` | yes | no | `` |
| `experimental_session_assignment_snapshot_id` | `TEXT` | yes | no | `` |
| `experimental_session_assignment_revision` | `INTEGER` | yes | no | `` |
| `experimental_session_supersedes_assignment_snapshot_id` | `TEXT` | yes | no | `` |
| `experimental_session_assignment_batch_id` | `TEXT` | yes | no | `` |
| `experimental_session_assignment_schema_id` | `TEXT` | yes | no | `` |
| `experimental_session_assignment_method` | `TEXT` | yes | no | `` |
| `experimental_session_assigned_by` | `TEXT` | yes | no | `` |
| `experimental_session_assigned_at_utc` | `TEXT` | yes | no | `` |
| `experimental_session_current_updated_at_utc` | `TEXT` | yes | no | `` |
| `experimental_session_assignment_evidence_json` | `TEXT` | yes | no | `` |
| `experimental_session_assignment_registry_schema_version` | `INTEGER` | yes | no | `` |
| `zarr_path` | `TEXT` | yes | no | `` |
| `artifact_kind` | `TEXT` | yes | no | `` |
| `zarr_origin` | `TEXT` | yes | no | `` |
| `zarr_use` | `TEXT` | yes | no | `` |
