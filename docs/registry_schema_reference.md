...
| `color_range` | `TEXT` | yes | no | `` |
| `color_space` | `TEXT` | yes | no | `` |
| `color_transfer` | `TEXT` | yes | no | `` |
| `color_primaries` | `TEXT` | yes | no | `` |
...
| `crop_schema_id` | `TEXT` | yes | no | `` |
| `source_pixels` | `TEXT` | yes | no | `` |
| `provider_record_sha256` | `TEXT` | yes | no | `` |
| `routing_policy_id` | `TEXT` | yes | no | `` |
| `crop_policy_id` | `TEXT` | yes | no | `` |
| `source_acquisition_mode` | `TEXT` | yes | no | `` |
| `source_acquisition_ledger_record_sha256` | `TEXT` | yes | no | `` |
| `acquisition_video_rows` | `INTEGER` | yes | no | `` |
| `full_frame_recovery_rows` | `INTEGER` | yes | no | `` |
| `crop_pixel_routing_ready` | `INTEGER` | yes | no | `` |
...
|---|---|---|---|---|
| `dataset_id` | `TEXT` | no | yes | `` |
| `identity_scope_id` | `TEXT` | no | no | `` |
| `recording_id` | `TEXT` | no | no | `` |
| `session_uuid` | `TEXT` | no | no | `` |
| `identity_snapshot_id` | `TEXT` | no | no | `` |
| `identity_revision` | `INTEGER` | no | no | `` |
| `projected_at_utc` | `TEXT` | no | no | `` |
...
| FK ID | From | To | On Update | On Delete | Match |
|---|---|---|---|---|---|
| `0` | `identity_scope_id` | `recording_identity_current.identity_scope_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `recording_id` | `recording_identity_current.recording_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `session_uuid` | `recording_identity_current.session_uuid` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `identity_snapshot_id` | `recording_identity_current.identity_snapshot_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `identity_revision` | `recording_identity_current.identity_revision` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `dataset_id` | `datasets.dataset_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `recording_id` | `datasets.recording_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `session_uuid` | `datasets.session_uuid` | `NO ACTION` | `RESTRICT` | `NONE` |

#### Indexes

| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_dataset_recording_identity_current_1` | yes | `pk` | no | `dataset_id` |
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `idx_datasets_exact_identity` | yes | `c` | no | `dataset_id`, `recording_id`, `session_uuid` |
...
```sql
CREATE TABLE recording_identity_current (
...
| FK ID | From | To | On Update | On Delete | Match |
|---|---|---|---|---|---|
| `0` | `identity_scope_id` | `recording_identity_revisions.identity_scope_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `recording_id` | `recording_identity_revisions.recording_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `session_uuid` | `recording_identity_revisions.session_uuid` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `identity_snapshot_id` | `recording_identity_revisions.identity_snapshot_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `0` | `identity_revision` | `recording_identity_revisions.identity_revision` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `recording_id` | `recordings.recording_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `session_uuid` | `recordings.session_uuid` | `NO ACTION` | `RESTRICT` | `NONE` |

#### Indexes

| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_recording_identity_current_5` | yes | `u` | no | `identity_scope_id`, `recording_id`, `session_uuid`, `identity_snapshot_id`, `identity_revision` |
| `sqlite_autoindex_recording_identity_current_4` | yes | `u` | no | `identity_scope_id`, `recording_id`, `session_uuid`, `identity_snapshot_id` |
| `sqlite_autoindex_recording_identity_current_3` | yes | `u` | no | `identity_snapshot_id` |
| `sqlite_autoindex_recording_identity_current_2` | yes | `u` | no | `recording_id` |
| `sqlite_autoindex_recording_identity_current_1` | yes | `pk` | no | `identity_scope_id` |

### `recording_identity_evidence`

| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `evidence_digest` | `TEXT` | no | yes | `` |
| `schema_id` | `TEXT` | no | no | `` |
| `evidence_json` | `TEXT` | no | no | `` |
...
```sql
CREATE TABLE recording_identity_evidence (
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_recording_identity_evidence_1` | yes | `pk` | no | `evidence_digest` |

### `recording_identity_revisions`

| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `identity_snapshot_id` | `TEXT` | no | yes | `` |
| `identity_scope_id` | `TEXT` | no | no | `` |
| `recording_id` | `TEXT` | no | no | `` |
| `session_uuid` | `TEXT` | no | no | `` |
| `identity_revision` | `INTEGER` | no | no | `` |
| `supersedes_identity_snapshot_id` | `TEXT` | yes | no | `` |
| `schema_id` | `TEXT` | no | no | `` |
| `revision_kind` | `TEXT` | no | no | `` |
| `decided_by` | `TEXT` | no | no | `` |
| `decided_at_utc` | `TEXT` | no | no | `` |
| `correction_reason` | `TEXT` | yes | no | `` |
| `evidence_digest` | `TEXT` | no | no | `` |
| `initiating_dataset_id` | `TEXT` | no | no | `` |
| `registry_schema_version` | `INTEGER` | no | no | `` |

#### Definition

```sql
CREATE TABLE recording_identity_revisions (
...
| FK ID | From | To | On Update | On Delete | Match |
|---|---|---|---|---|---|
| `0` | `evidence_digest` | `recording_identity_evidence.evidence_digest` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `identity_scope_id` | `recording_identity_revisions.identity_scope_id` | `NO ACTION` | `RESTRICT` | `NONE` |
| `1` | `supersedes_identity_snapshot_id` | `recording_identity_revisions.identity_snapshot_id` | `NO ACTION` | `RESTRICT` | `NONE` |

#### Indexes

| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `idx_recording_identity_revisions_evidence` | no | `c` | no | `evidence_digest` |
| `sqlite_autoindex_recording_identity_revisions_6` | yes | `u` | no | `identity_scope_id`, `recording_id`, `session_uuid`, `identity_snapshot_id`, `identity_revision` |
| `sqlite_autoindex_recording_identity_revisions_5` | yes | `u` | no | `identity_scope_id`, `recording_id`, `session_uuid`, `identity_snapshot_id` |
| `sqlite_autoindex_recording_identity_revisions_4` | yes | `u` | no | `identity_scope_id`, `identity_snapshot_id` |
| `sqlite_autoindex_recording_identity_revisions_3` | yes | `u` | no | `identity_scope_id`, `identity_revision` |
| `sqlite_autoindex_recording_identity_revisions_2` | yes | `u` | no | `supersedes_identity_snapshot_id` |
| `sqlite_autoindex_recording_identity_revisions_1` | yes | `pk` | no | `identity_snapshot_id` |

### `recording_import_receipt_bindings`

| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `receipt_sha256` | `TEXT` | no | yes | `` |
| `dataset_id` | `TEXT` | no | no | `` |
| `identity_scope_id` | `TEXT` | no | no | `` |
| `identity_snapshot_id` | `TEXT` | no | no | `` |
| `bound_by` | `TEXT` | no | no | `` |
| `bound_at_utc` | `TEXT` | no | no | `` |
| `registry_schema_version` | `INTEGER` | no | no | `` |
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_recording_import_receipt_bindings_2` | yes | `u` | no | `dataset_id`, `identity_scope_id`, `identity_snapshot_id` |
| `sqlite_autoindex_recording_import_receipt_bindings_1` | yes | `pk` | no | `receipt_sha256` |
...
| `source_zarr_path` | `TEXT` | no | no | `` |
| `extracted_utc` | `TEXT` | no | no | `` |
| `protocol_semantic_status` | `TEXT` | yes | no | `` |
| `protocol_semantic_hash` | `TEXT` | yes | no | `` |
| `palette_computed_trial_index_sha256` | `TEXT` | yes | no | `` |
| `protocol_trial_index_sha256` | `TEXT` | yes | no | `` |
| `producer_protocol_trial_index_hash` | `TEXT` | yes | no | `` |
| `protocol_trial_index_integrity_status` | `TEXT` | yes | no | `` |
| `protocol_snapshot_schema_version` | `INTEGER` | yes | no | `` |
| `protocol_snapshot_policy_id` | `TEXT` | yes | no | `` |
| `protocol_trial_index_schema_version` | `INTEGER` | yes | no | `` |
| `protocol_execution_status` | `TEXT` | yes | no | `` |
| `protocol_execution_hash` | `TEXT` | yes | no | `` |
| `protocol_interval_axis` | `TEXT` | yes | no | `` |
| `protocol_acquisition_containment_status` | `TEXT` | yes | no | `` |
| `protocol_frame_correspondence_proxy_status` | `TEXT` | yes | no | `` |
| `protocol_frame_correspondence_proxy_manifest_sha256` | `TEXT` | yes | no | `` |
| `protocol_frame_correspondence_proxy_missing_count` | `INTEGER` | yes | no | `` |
| `protocol_recipe_schema_id` | `TEXT` | yes | no | `` |
| `protocol_recipe_schema_version` | `INTEGER` | yes | no | `` |
| `protocol_recipe_step_count` | `INTEGER` | yes | no | `` |
| `protocol_recipe_mode_sequence_json` | `TEXT` | yes | no | `` |
| `protocol_recipe_label` | `TEXT` | yes | no | `` |
...
CREATE TABLE recording_stimulus_runs (
                ...
                source_metadata_sha256 TEXT NOT NULL,
                source_zarr_path TEXT NOT NULL,
                extracted_utc TEXT NOT NULL, protocol_semantic_status TEXT, protocol_semantic_hash TEXT, palette_computed_trial_index_sha256 TEXT, protocol_trial_index_sha256 TEXT, producer_protocol_trial_index_hash TEXT, protocol_trial_index_integrity_status TEXT, protocol_snapshot_schema_version INTEGER, protocol_snapshot_policy_id TEXT, protocol_trial_index_schema_version INTEGER, protocol_execution_status TEXT, protocol_execution_hash TEXT, protocol_interval_axis TEXT, protocol_acquisition_containment_status TEXT, protocol_frame_correspondence_proxy_status TEXT, protocol_frame_correspondence_proxy_manifest_sha256 TEXT, protocol_frame_correspondence_proxy_missing_count INTEGER, protocol_recipe_schema_id TEXT, protocol_recipe_schema_version INTEGER, protocol_recipe_step_count INTEGER, protocol_recipe_mode_sequence_json TEXT, protocol_recipe_label TEXT,
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `idx_recording_stimulus_runs_semantic` | no | `c` | no | `protocol_semantic_status`, `protocol_semantic_hash`, `protocol_recipe_label`, `dataset_id`, `stimulus_run_id` |
...
| `protocol_semantic_status` | `TEXT` | yes | no | `` |
| `protocol_semantic_hash` | `TEXT` | yes | no | `` |
| `protocol_semantic_step_index` | `INTEGER` | yes | no | `` |
| `protocol_semantic_step_ref` | `TEXT` | yes | no | `` |
| `protocol_semantic_stimulus_mode_id` | `INTEGER` | yes | no | `` |
| `protocol_semantic_duration_s` | `REAL` | yes | no | `` |
| `stimulus_family` | `TEXT` | yes | no | `` |
| `display_context` | `TEXT` | yes | no | `` |
| `protocol_trial_index_status` | `TEXT` | yes | no | `` |
| `resolved_color_rgba8_json` | `TEXT` | yes | no | `` |
| `start_stimulus_frame_inclusive` | `INTEGER` | yes | no | `` |
| `end_stimulus_frame_exclusive` | `INTEGER` | yes | no | `` |
| `first_camera_frame_id_correspondence` | `INTEGER` | yes | no | `` |
| `last_camera_frame_id_correspondence` | `INTEGER` | yes | no | `` |
| `authoritative_interval_axis` | `TEXT` | yes | no | `` |
| `execution_completion_status` | `TEXT` | yes | no | `` |
| `execution_end_reason` | `TEXT` | yes | no | `` |
| `protocol_execution_phases_json` | `TEXT` | yes | no | `` |
...
CREATE TABLE recording_stimulus_steps (
                ...
                duration_s REAL,
                step_attrs_json TEXT NOT NULL, protocol_semantic_status TEXT, protocol_semantic_hash TEXT, protocol_semantic_step_index INTEGER, protocol_semantic_step_ref TEXT, protocol_semantic_stimulus_mode_id INTEGER, protocol_semantic_duration_s REAL, stimulus_family TEXT, display_context TEXT, protocol_trial_index_status TEXT, resolved_color_rgba8_json TEXT, start_stimulus_frame_inclusive INTEGER, end_stimulus_frame_exclusive INTEGER, first_camera_frame_id_correspondence INTEGER, last_camera_frame_id_correspondence INTEGER, authoritative_interval_axis TEXT, execution_completion_status TEXT, execution_end_reason TEXT, protocol_execution_phases_json TEXT,
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `idx_recording_stimulus_steps_semantic` | no | `c` | no | `protocol_semantic_hash`, `stimulus_family`, `display_context`, `dataset_id`, `stimulus_run_id`, `protocol_semantic_step_index` |
...
| `created_utc` | `TEXT` | yes | no | `` |
| `updated_utc` | `TEXT` | yes | no | `` |
| `context_source` | `TEXT` | yes | no | `` |
| `recording_context_schema_version` | `INTEGER` | yes | no | `` |
| `recording_intent` | `TEXT` | yes | no | `` |
| `data_origin` | `TEXT` | yes | no | `` |
...
CREATE TABLE recordings (
                ...
                created_utc TEXT,
                updated_utc TEXT
            , context_source TEXT, recording_context_schema_version INTEGER, recording_intent TEXT, data_origin TEXT)
```
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `idx_recordings_exact_identity` | yes | `c` | no | `recording_id`, `session_uuid` |
...
| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `singleton_id` | `INTEGER` | no | yes | `` |
| `registry_uuid` | `TEXT` | no | no | `` |
| `identity_provenance` | `TEXT` | no | no | `` |
| `minted_at_utc` | `TEXT` | no | no | `` |
...
| Index | Unique | Origin | Partial | Columns |
|---|---|---|---|---|
| `sqlite_autoindex_registry_identity_1` | yes | `u` | no | `registry_uuid` |
...
SQLite-inferred view affinities are intentionally omitted because they vary across SQLite releases.

| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `export_run_id` | `` | yes | no | `` |
| `status` | `` | yes | no | `` |
| `collection_id` | `` | yes | no | `` |
| `collection_manifest_sha256` | `` | yes | no | `` |
| `collection_name` | `` | yes | no | `` |
| `export_manifest_path` | `` | yes | no | `` |
| `output_root` | `` | yes | no | `` |
| `created_at_utc` | `` | yes | no | `` |
| `indexed_utc` | `` | yes | no | `` |
| `source_recording_count` | `` | yes | no | `` |
| `table_count` | `` | yes | no | `` |
| `diagnostics_count` | `` | yes | no | `` |
| `row_counts_json` | `` | yes | no | `` |
| `tables_json` | `` | yes | no | `` |
| `palette_git_commit` | `` | yes | no | `` |
| `palette_git_dirty` | `` | yes | no | `` |
...
| `collection_name` | `` | yes | no | `` |
| `export_manifest_path` | `` | yes | no | `` |
| `analytics_output_root` | `` | yes | no | `` |
| `report_manifest_path` | `` | yes | no | `` |
| `report_manifest_sha256` | `` | yes | no | `` |
| `report_output_root` | `` | yes | no | `` |
| `schema_id` | `` | yes | no | `` |
| `schema_version` | `` | yes | no | `` |
| `materialization_policy` | `` | yes | no | `` |
| `source_backends_json` | `` | yes | no | `` |
| `source_tables_json` | `` | yes | no | `` |
| `visualization_count` | `` | yes | no | `` |
| `artifact_count` | `` | yes | no | `` |
| `nonready_count` | `` | yes | no | `` |
| `created_at_utc` | `` | yes | no | `` |
| `indexed_utc` | `` | yes | no | `` |
| `metadata_json` | `` | yes | no | `` |
...
| `recording_id` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `crop_created_utc` | `` | yes | no | `` |
| `source_detect_run` | `` | yes | no | `` |
| `source_refined_run` | `` | yes | no | `` |
| `detection_source_type` | `` | yes | no | `` |
| `detection_source_path` | `` | yes | no | `` |
| `crop_storage_mode` | `` | yes | no | `` |
| `roi_image_representation` | `` | yes | no | `` |
| `roi_pixel_contract_name` | `` | yes | no | `` |
| `roi_pixel_contract_json` | `` | yes | no | `` |
| `crop_schema_id` | `` | yes | no | `` |
| `source_pixels` | `` | yes | no | `` |
| `provider_record_sha256` | `` | yes | no | `` |
| `routing_policy_id` | `` | yes | no | `` |
| `crop_policy_id` | `` | yes | no | `` |
| `source_acquisition_mode` | `` | yes | no | `` |
| `source_acquisition_ledger_record_sha256` | `` | yes | no | `` |
| `acquisition_video_rows` | `` | yes | no | `` |
| `full_frame_recovery_rows` | `` | yes | no | `` |
| `crop_pixel_routing_ready` | `` | yes | no | `` |
| `total_rois` | `` | yes | no | `` |
| `frames_with_crops` | `` | yes | no | `` |
| `total_frames` | `` | yes | no | `` |
| `percent_frames_with_crops` | `` | yes | no | `` |
| `includes_interpolated` | `` | yes | no | `` |
| `n_real_detections` | `` | yes | no | `` |
| `n_interpolated_detections` | `` | yes | no | `` |
| `review_state` | `` | yes | no | `` |
| `review_method` | `` | yes | no | `` |
| `review_intended_use` | `` | yes | no | `` |
| `review_reviewer` | `` | yes | no | `` |
| `review_timestamp_utc` | `` | yes | no | `` |
| `review_notes` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
...
| `frame_clock` | `` | yes | no | `` |
| `video_path` | `` | yes | no | `` |
| `metadata_path` | `` | yes | no | `` |
| `frame_clock_metadata_path` | `` | yes | no | `` |
| `keyframes_path` | `` | yes | no | `` |
| `summary_path` | `` | yes | no | `` |
| `status_path` | `` | yes | no | `` |
| `width` | `` | yes | no | `` |
| `height` | `` | yes | no | `` |
...
| `codec` | `` | yes | no | `` |
| `container` | `` | yes | no | `` |
| `encoded_format` | `` | yes | no | `` |
| `pixel_source_format` | `` | yes | no | `` |
| `color_range` | `` | yes | no | `` |
| `color_space` | `` | yes | no | `` |
| `color_transfer` | `` | yes | no | `` |
| `color_primaries` | `` | yes | no | `` |
| `video_pixel_coordinate_space` | `` | yes | no | `` |
| `source_geometry_coordinate_space` | `` | yes | no | `` |
| `blank_frame_policy` | `` | yes | no | `` |
| `selection_policy` | `` | yes | no | `` |
| `availability_status` | `` | yes | no | `` |
| `inventory_status` | `` | yes | no | `` |
| `video_exists` | `` | yes | no | `` |
| `metadata_exists` | `` | yes | no | `` |
| `frame_clock_metadata_exists` | `` | yes | no | `` |
| `keyframes_exists` | `` | yes | no | `` |
| `summary_exists` | `` | yes | no | `` |
| `status_exists` | `` | yes | no | `` |
| `metadata_row_count` | `` | yes | no | `` |
| `frame_clock_metadata_row_count` | `` | yes | no | `` |
| `frames_encoded` | `` | yes | no | `` |
| `frames_dropped` | `` | yes | no | `` |
| `canonical_ledger_status` | `` | yes | no | `` |
| `canonical_ledger_run` | `` | yes | no | `` |
| `canonical_ledger_path` | `` | yes | no | `` |
| `canonical_ledger_record_sha256` | `` | yes | no | `` |
| `canonical_ledger_source_metadata_sha256` | `` | yes | no | `` |
| `canonical_ledger_source_video_fingerprint` | `` | yes | no | `` |
| `canonical_ledger_row_count` | `` | yes | no | `` |
| `canonical_ledger_detected_row_count` | `` | yes | no | `` |
| `canonical_ledger_blank_row_count` | `` | yes | no | `` |
| `canonical_ledger_imported_at_utc` | `` | yes | no | `` |
| `contract_json` | `` | yes | no | `` |
| `files_json` | `` | yes | no | `` |
| `summary_json` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
...
| `recording_id` | `` | yes | no | `` |
| `session_uuid` | `` | yes | no | `` |
| `acquisition_batch_id` | `` | yes | no | `` |
| `acquisition_batch_snapshot_id` | `` | yes | no | `` |
| `acquisition_batch_schema_id` | `` | yes | no | `` |
| `acquisition_batch_creation_method` | `` | yes | no | `` |
| `acquisition_batch_created_by` | `` | yes | no | `` |
| `acquisition_batch_created_at_utc` | `` | yes | no | `` |
| `acquisition_batch_creation_evidence_json` | `` | yes | no | `` |
| `acquisition_batch_creation_registry_schema_version` | `` | yes | no | `` |
| `acquisition_batch_identity_status` | `` | yes | no | `` |
| `acquisition_batch_assignment_snapshot_id` | `` | yes | no | `` |
| `acquisition_batch_assignment_revision` | `` | yes | no | `` |
| `acquisition_batch_supersedes_assignment_snapshot_id` | `` | yes | no | `` |
| `acquisition_batch_assignment_batch_id` | `` | yes | no | `` |
| `acquisition_batch_assignment_schema_id` | `` | yes | no | `` |
| `acquisition_batch_assignment_method` | `` | yes | no | `` |
| `acquisition_batch_assigned_by` | `` | yes | no | `` |
| `acquisition_batch_assigned_at_utc` | `` | yes | no | `` |
| `acquisition_batch_current_updated_at_utc` | `` | yes | no | `` |
| `acquisition_batch_assignment_evidence_json` | `` | yes | no | `` |
| `acquisition_batch_assignment_registry_schema_version` | `` | yes | no | `` |
| `zarr_path` | `` | yes | no | `` |
| `artifact_kind` | `` | yes | no | `` |
| `zarr_origin` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `source_layout` | `` | yes | no | `` |
| `source_frame_index_path` | `` | yes | no | `` |
| `source_recording_frame_index_path` | `` | yes | no | `` |
| `source_frame_index_schema` | `` | yes | no | `` |
| `dataset_status` | `` | yes | no | `` |
| `last_seen_utc` | `` | yes | no | `` |
| `recording_name` | `` | yes | no | `` |
| `recording_path` | `` | yes | no | `` |
| `recording_started_utc` | `` | yes | no | `` |
| `recording_type` | `` | yes | no | `` |
| `recording_subtype` | `` | yes | no | `` |
| `behavior_mode` | `` | yes | no | `` |
| `artifact_schema_id` | `` | yes | no | `` |
| `experiment_context_status` | `` | yes | no | `` |
| `experiment_context_source` | `` | yes | no | `` |
| `experiment_context_status_detail` | `` | yes | no | `` |
| `stimulus_runs_available` | `` | yes | no | `` |
| `rig_id` | `` | yes | no | `` |
| `arena_id` | `` | yes | no | `` |
| `camera_id` | `` | yes | no | `` |
| `canvas_name` | `` | yes | no | `` |
...
| `dish_design` | `` | yes | no | `` |
| `protocol_hash` | `` | yes | no | `` |
| `snapshot_status` | `` | yes | no | `` |
| `snapshot_missing_json` | `` | yes | no | `` |
| `fps` | `` | yes | no | `` |
| `video_codec` | `` | yes | no | `` |
| `video_pix_fmt` | `` | yes | no | `` |
| `compression_name` | `` | yes | no | `` |
| `compression_level` | `` | yes | no | `` |
| `exposure` | `` | yes | no | `` |
| `exposure_unit` | `` | yes | no | `` |
| `gain` | `` | yes | no | `` |
| `frame_rate` | `` | yes | no | `` |
| `camera_model` | `` | yes | no | `` |
| `camera_serial` | `` | yes | no | `` |
| `has_images_ds` | `` | yes | no | `` |
| `has_images_ds_rgb` | `` | yes | no | `` |
| `downsample_formats_json` | `` | yes | no | `` |
| `subject_count_snapshot` | `` | yes | no | `` |
...
| `legacy_sex` | `` | yes | no | `` |
| `legacy_dpf_at_acquisition` | `` | yes | no | `` |
| `subject_id` | `` | yes | no | `` |
| `dish_id` | `` | yes | no | `` |
| `cross_id` | `` | yes | no | `` |
| `genotype` | `` | yes | no | `` |
...
| Column | Type | Nullable | PK | Default |
|---|---|---|---|---|
| `child_dataset_id` | `` | yes | no | `` |
| `parent_dataset_id` | `` | yes | no | `` |
| `relationship_type` | `` | yes | no | `` |
| `source_set_id` | `` | yes | no | `` |
| `metadata_json` | `` | yes | no | `` |
| `created_utc` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
...
| `dataset_id` | `` | yes | no | `` |
| `detect_run` | `` | yes | no | `` |
| `detect_created_utc` | `` | yes | no | `` |
| `recording_id` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `detection_method` | `` | yes | no | `` |
| `model_run_id` | `` | yes | no | `` |
| `model_set_id` | `` | yes | no | `` |
| `model_path` | `` | yes | no | `` |
| `model_name` | `` | yes | no | `` |
| `coverage_percent` | `` | yes | no | `` |
| `frames_with_detections` | `` | yes | no | `` |
| `frames_zero_detections` | `` | yes | no | `` |
| `total_frames` | `` | yes | no | `` |
| `mean_confidence` | `` | yes | no | `` |
| `min_confidence` | `` | yes | no | `` |
| `max_confidence` | `` | yes | no | `` |
| `inference_duration_seconds` | `` | yes | no | `` |
| `inference_average_fps` | `` | yes | no | `` |
| `inference_avg_batch_ms` | `` | yes | no | `` |
| `inference_avg_read_ms` | `` | yes | no | `` |
| `conf_threshold` | `` | yes | no | `` |
| `iou_threshold` | `` | yes | no | `` |
| `batch_size` | `` | yes | no | `` |
| `inference_width` | `` | yes | no | `` |
| `inference_height` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
...
| `dataset_id` | `` | yes | no | `` |
| `refined_run` | `` | yes | no | `` |
| `refined_created_utc` | `` | yes | no | `` |
| `source_detect_run` | `` | yes | no | `` |
| `detect_method` | `` | yes | no | `` |
| `review_state` | `` | yes | no | `` |
| `review_method` | `` | yes | no | `` |
| `review_intended_use` | `` | yes | no | `` |
| `review_reviewer` | `` | yes | no | `` |
| `review_notes` | `` | yes | no | `` |
| `review_timestamp_utc` | `` | yes | no | `` |
| `review_resolved_group` | `` | yes | no | `` |
| `total_detections` | `` | yes | no | `` |
| `real_detections` | `` | yes | no | `` |
| `interpolated_detections` | `` | yes | no | `` |
| `interpolated_detections_rate` | `` | yes | no | `` |
| `quality_updated_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
...
| `recording_id` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `detection_type` | `` | yes | no | `` |
| `detection_path` | `` | yes | no | `` |
| `profile_created_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
| `frames_total` | `` | yes | no | `` |
| `frames_with_detections` | `` | yes | no | `` |
| `coverage_percent` | `` | yes | no | `` |
| `detections_total` | `` | yes | no | `` |
| `detections_per_frame_p50` | `` | yes | no | `` |
| `detections_per_frame_p90` | `` | yes | no | `` |
| `w_p10` | `` | yes | no | `` |
| `w_p50` | `` | yes | no | `` |
| `w_p90` | `` | yes | no | `` |
| `h_p10` | `` | yes | no | `` |
...
| `area_p50` | `` | yes | no | `` |
| `area_p90` | `` | yes | no | `` |
| `aspect_ratio_p10` | `` | yes | no | `` |
| `aspect_ratio_p50` | `` | yes | no | `` |
| `aspect_ratio_p90` | `` | yes | no | `` |
| `edge_proximity_rate` | `` | yes | no | `` |
| `rig_id` | `` | yes | no | `` |
| `camera_id` | `` | yes | no | `` |
| `arena_id` | `` | yes | no | `` |
| `dish_design` | `` | yes | no | `` |
...
| `zarr_use` | `` | yes | no | `` |
| `stage_group` | `` | yes | no | `` |
| `eye_mask_method` | `` | yes | no | `` |
| `source_eye_mask_path` | `` | yes | no | `` |
| `source_eye_mask_run` | `` | yes | no | `` |
| `source_keypoint_path` | `` | yes | no | `` |
| `source_keypoint_run` | `` | yes | no | `` |
| `source_crop_run` | `` | yes | no | `` |
| `profile_created_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
| `rows_total` | `` | yes | no | `` |
| `rows_usable` | `` | yes | no | `` |
| `usable_rate` | `` | yes | no | `` |
| `reviewed_rate` | `` | yes | no | `` |
| `excluded_rate` | `` | yes | no | `` |
| `exclusion_reasons_json` | `` | yes | no | `` |
| `ellipse_success_rate` | `` | yes | no | `` |
| `pair_success_rate` | `` | yes | no | `` |
| `area_p10` | `` | yes | no | `` |
| `area_p50` | `` | yes | no | `` |
| `area_p90` | `` | yes | no | `` |
| `left_area_p10` | `` | yes | no | `` |
| `left_area_p50` | `` | yes | no | `` |
| `left_area_p90` | `` | yes | no | `` |
| `right_area_p10` | `` | yes | no | `` |
| `right_area_p50` | `` | yes | no | `` |
| `right_area_p90` | `` | yes | no | `` |
| `union_area_p10` | `` | yes | no | `` |
| `union_area_p50` | `` | yes | no | `` |
| `union_area_p90` | `` | yes | no | `` |
| `area_lr_ratio_p10` | `` | yes | no | `` |
| `area_lr_ratio_p50` | `` | yes | no | `` |
| `area_lr_ratio_p90` | `` | yes | no | `` |
| `major_axis_p10` | `` | yes | no | `` |
| `major_axis_p50` | `` | yes | no | `` |
| `major_axis_p90` | `` | yes | no | `` |
| `minor_axis_p10` | `` | yes | no | `` |
| `minor_axis_p50` | `` | yes | no | `` |
| `minor_axis_p90` | `` | yes | no | `` |
| `aspect_ratio_p10` | `` | yes | no | `` |
| `aspect_ratio_p50` | `` | yes | no | `` |
| `aspect_ratio_p90` | `` | yes | no | `` |
| `eye_separation_p10` | `` | yes | no | `` |
| `eye_separation_p50` | `` | yes | no | `` |
| `eye_separation_p90` | `` | yes | no | `` |
| `edge_proximity_rate` | `` | yes | no | `` |
| `review_state` | `` | yes | no | `` |
| `review_method` | `` | yes | no | `` |
| `review_intended_use` | `` | yes | no | `` |
| `review_timestamp_utc` | `` | yes | no | `` |
| `source_keypoint_stale_state` | `` | yes | no | `` |
| `source_keypoint_stale_reason` | `` | yes | no | `` |
| `source_keypoint_stale_timestamp_utc` | `` | yes | no | `` |
| `source_keypoint_stale_json` | `` | yes | no | `` |
| `rig_id` | `` | yes | no | `` |
| `camera_id` | `` | yes | no | `` |
| `arena_id` | `` | yes | no | `` |
| `dish_design` | `` | yes | no | `` |
...
| `stage_group` | `` | yes | no | `` |
| `run_name` | `` | yes | no | `` |
| `run_created_utc` | `` | yes | no | `` |
| `recording_id` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `method` | `` | yes | no | `` |
| `source_crop_run` | `` | yes | no | `` |
| `source_keypoint_group` | `` | yes | no | `` |
| `source_keypoints_run` | `` | yes | no | `` |
| `source_eye_masks_run` | `` | yes | no | `` |
| `source_eye_masks_method` | `` | yes | no | `` |
| `total_rois` | `` | yes | no | `` |
| `successful_eyes` | `` | yes | no | `` |
| `successful_roi_pairs` | `` | yes | no | `` |
| `successful_roi_pair_rate` | `` | yes | no | `` |
| `duration_seconds` | `` | yes | no | `` |
| `rois_per_second` | `` | yes | no | `` |
| `inference_duration_seconds` | `` | yes | no | `` |
| `inference_average_fps` | `` | yes | no | `` |
| `reason_counts_json` | `` | yes | no | `` |
| `summary_statistics_json` | `` | yes | no | `` |
| `review_state` | `` | yes | no | `` |
| `review_method` | `` | yes | no | `` |
| `review_intended_use` | `` | yes | no | `` |
| `review_reviewer` | `` | yes | no | `` |
...
| `recording_id` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `keypoint_method` | `` | yes | no | `` |
| `source_keypoint_path` | `` | yes | no | `` |
| `source_keypoint_run` | `` | yes | no | `` |
| `skeleton_id` | `` | yes | no | `` |
| `kpt_shape` | `` | yes | no | `` |
| `pose_schema_name` | `` | yes | no | `` |
| `pose_schema_json` | `` | yes | no | `` |
| `heading_computation_source` | `` | yes | no | `` |
| `heading_computation_json` | `` | yes | no | `` |
| `profile_created_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
| `rows_total` | `` | yes | no | `` |
| `rows_usable` | `` | yes | no | `` |
| `usable_keypoints_total` | `` | yes | no | `` |
| `usable_rate` | `` | yes | no | `` |
| `confidence_valid_rate` | `` | yes | no | `` |
| `geometry_valid_rate` | `` | yes | no | `` |
| `triangle_area_p10` | `` | yes | no | `` |
| `triangle_area_p50` | `` | yes | no | `` |
| `triangle_area_p90` | `` | yes | no | `` |
| `min_angle_p10` | `` | yes | no | `` |
| `min_angle_p50` | `` | yes | no | `` |
| `min_angle_p90` | `` | yes | no | `` |
| `heading_p10` | `` | yes | no | `` |
| `heading_p50` | `` | yes | no | `` |
| `heading_p90` | `` | yes | no | `` |
| `rig_id` | `` | yes | no | `` |
...
| `source_detect_run` | `` | yes | no | `` |
| `source_refined_run` | `` | yes | no | `` |
| `source_crop_storage_mode` | `` | yes | no | `` |
| `source_crop_signature` | `` | yes | no | `` |
| `source_crop_revision` | `` | yes | no | `` |
| `source_roi_image_representation` | `` | yes | no | `` |
| `source_roi_pixel_contract_name` | `` | yes | no | `` |
| `source_roi_pixel_contract_json` | `` | yes | no | `` |
| `source_roi_read_mode` | `` | yes | no | `` |
| `roi_cache_policy` | `` | yes | no | `` |
| `source_roi_cache_used` | `` | yes | no | `` |
| `source_roi_cache_backend` | `` | yes | no | `` |
| `source_roi_live_acceleration_effective` | `` | yes | no | `` |
| `source_roi_live_gpu_chunk_frames` | `` | yes | no | `` |
| `input_mode_requested` | `` | yes | no | `` |
| `input_mode_effective` | `` | yes | no | `` |
| `total_rois` | `` | yes | no | `` |
| `successful_detections` | `` | yes | no | `` |
| `failed_detections` | `` | yes | no | `` |
| `success_rate_percent` | `` | yes | no | `` |
| `frames_with_keypoints` | `` | yes | no | `` |
| `mean_confidence` | `` | yes | no | `` |
| `duration_seconds` | `` | yes | no | `` |
| `inference_duration_seconds` | `` | yes | no | `` |
| `keypoints_per_second` | `` | yes | no | `` |
| `inference_average_fps` | `` | yes | no | `` |
| `batch_size` | `` | yes | no | `` |
| `imgsz` | `` | yes | no | `` |
| `conf_threshold` | `` | yes | no | `` |
...
| `review_reviewer` | `` | yes | no | `` |
| `review_notes` | `` | yes | no | `` |
| `review_policy_id` | `` | yes | no | `` |
| `review_policy_version` | `` | yes | no | `` |
| `review_timestamp_utc` | `` | yes | no | `` |
| `usable_keypoints` | `` | yes | no | `` |
| `total_keypoints` | `` | yes | no | `` |
| `usable_keypoints_rate` | `` | yes | no | `` |
| `raw_keypoints_success_rate` | `` | yes | no | `` |
| `raw_keypoints_successful` | `` | yes | no | `` |
| `quality_updated_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
...
| `set_id` | `` | yes | no | `` |
| `task_type` | `` | yes | no | `` |
| `artifact_path` | `` | yes | no | `` |
| `artifact_sha256` | `` | yes | no | `` |
| `artifact_precision` | `` | yes | no | `` |
| `input_shape` | `` | yes | no | `` |
| `input_layout` | `` | yes | no | `` |
| `input_channels` | `` | yes | no | `` |
| `img_h` | `` | yes | no | `` |
| `img_w` | `` | yes | no | `` |
| `max_batch` | `` | yes | no | `` |
| `dynamic_shapes` | `` | yes | no | `` |
| `input_dtype` | `` | yes | no | `` |
| `input_color_space` | `` | yes | no | `` |
| `input_shape_source` | `` | yes | no | `` |
| `input_shape_status` | `` | yes | no | `` |
| `created_utc` | `` | yes | no | `` |
...
| `protocol_name` | `` | yes | no | `` |
| `is_latest` | `` | yes | no | `` |
| `protocol_semantic_status` | `` | yes | no | `` |
| `protocol_semantic_hash` | `` | yes | no | `` |
| `palette_computed_trial_index_sha256` | `` | yes | no | `` |
| `protocol_trial_index_sha256` | `` | yes | no | `` |
| `producer_protocol_trial_index_hash` | `` | yes | no | `` |
| `protocol_trial_index_integrity_status` | `` | yes | no | `` |
| `protocol_snapshot_schema_version` | `` | yes | no | `` |
| `protocol_snapshot_policy_id` | `` | yes | no | `` |
| `protocol_trial_index_schema_version` | `` | yes | no | `` |
| `protocol_execution_status` | `` | yes | no | `` |
| `protocol_execution_hash` | `` | yes | no | `` |
| `protocol_interval_axis` | `` | yes | no | `` |
| `protocol_acquisition_containment_status` | `` | yes | no | `` |
| `protocol_frame_correspondence_proxy_status` | `` | yes | no | `` |
| `protocol_frame_correspondence_proxy_manifest_sha256` | `` | yes | no | `` |
| `protocol_frame_correspondence_proxy_missing_count` | `` | yes | no | `` |
| `protocol_recipe_schema_id` | `` | yes | no | `` |
| `protocol_recipe_schema_version` | `` | yes | no | `` |
| `protocol_recipe_step_count` | `` | yes | no | `` |
| `protocol_recipe_mode_sequence_json` | `` | yes | no | `` |
| `protocol_recipe_label` | `` | yes | no | `` |
| `stimulus_mode` | `` | yes | no | `` |
| `step_count` | `` | yes | no | `` |
| `total_duration_s` | `` | yes | no | `` |
| `source_zarr_path` | `` | yes | no | `` |
| `extracted_utc` | `` | yes | no | `` |
...
| `stage_group` | `` | yes | no | `` |
| `run_name` | `` | yes | no | `` |
| `component_name` | `` | yes | no | `` |
| `component_family` | `` | yes | no | `` |
| `run_created_utc` | `` | yes | no | `` |
| `subject_mask_method` | `` | yes | no | `` |
| `label_schema_id` | `` | yes | no | `` |
| `eye_component_mode` | `` | yes | no | `` |
| `source_subject_mask_run` | `` | yes | no | `` |
| `available` | `` | yes | no | `` |
| `review_state` | `` | yes | no | `` |
| `review_method` | `` | yes | no | `` |
| `review_intended_use` | `` | yes | no | `` |
...
| `review_timestamp_utc` | `` | yes | no | `` |
| `total_rois` | `` | yes | no | `` |
| `rows_with_component_mask` | `` | yes | no | `` |
| `rows_with_component_mask_rate` | `` | yes | no | `` |
| `source_subject_mask_stale_state` | `` | yes | no | `` |
| `source_subject_mask_stale_reason` | `` | yes | no | `` |
| `source_subject_mask_stale_timestamp_utc` | `` | yes | no | `` |
| `source_subject_mask_stale_json` | `` | yes | no | `` |
| `lifecycle_state` | `` | yes | no | `` |
| `lifecycle_reason` | `` | yes | no | `` |
| `quality_updated_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
...
| `source_keypoints_run` | `` | yes | no | `` |
| `source_crop_run` | `` | yes | no | `` |
| `run_semantics` | `` | yes | no | `` |
| `profile_created_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
| `total_rois` | `` | yes | no | `` |
| `rows_with_any_mask` | `` | yes | no | `` |
| `coverage_percent` | `` | yes | no | `` |
| `available_component_count` | `` | yes | no | `` |
| `subject_body_presence_rate` | `` | yes | no | `` |
| `subject_body_area_p10` | `` | yes | no | `` |
| `subject_body_area_p50` | `` | yes | no | `` |
| `subject_body_area_p90` | `` | yes | no | `` |
| `eyes_union_presence_rate` | `` | yes | no | `` |
| `eyes_union_area_p10` | `` | yes | no | `` |
| `eyes_union_area_p50` | `` | yes | no | `` |
| `eyes_union_area_p90` | `` | yes | no | `` |
| `eye_left_presence_rate` | `` | yes | no | `` |
| `eye_left_area_p10` | `` | yes | no | `` |
| `eye_left_area_p50` | `` | yes | no | `` |
| `eye_left_area_p90` | `` | yes | no | `` |
| `eye_right_presence_rate` | `` | yes | no | `` |
| `eye_right_area_p10` | `` | yes | no | `` |
| `eye_right_area_p50` | `` | yes | no | `` |
| `eye_right_area_p90` | `` | yes | no | `` |
| `swim_bladder_presence_rate` | `` | yes | no | `` |
| `swim_bladder_area_p10` | `` | yes | no | `` |
| `swim_bladder_area_p50` | `` | yes | no | `` |
| `swim_bladder_area_p90` | `` | yes | no | `` |
| `rig_id` | `` | yes | no | `` |
| `camera_id` | `` | yes | no | `` |
| `arena_id` | `` | yes | no | `` |
| `dish_design` | `` | yes | no | `` |
...
| `source_roi_live_acceleration_effective` | `` | yes | no | `` |
| `source_roi_live_gpu_chunk_frames` | `` | yes | no | `` |
| `mask_storage_encoding` | `` | yes | no | `` |
| `mask_store_encodings_json` | `` | yes | no | `` |
| `masks_roi_materialized` | `` | yes | no | `` |
| `mask_rle_materialized` | `` | yes | no | `` |
| `mask_rle_schema_id` | `` | yes | no | `` |
| `mask_rle_encoding` | `` | yes | no | `` |
| `mask_rle_layout` | `` | yes | no | `` |
| `masks_roi_logical_bytes` | `` | yes | no | `` |
| `masks_roi_stored_bytes` | `` | yes | no | `` |
| `masks_roi_materialized_from` | `` | yes | no | `` |
| `masks_roi_materialized_at_utc` | `` | yes | no | `` |
| `mask_rle_logical_bytes` | `` | yes | no | `` |
| `mask_rle_stored_bytes` | `` | yes | no | `` |
| `mask_rle_refreshed_at_utc` | `` | yes | no | `` |
| `mask_rle_refresh_row_count` | `` | yes | no | `` |
| `mask_rle_stale` | `` | yes | no | `` |
| `mask_rle_stale_reason` | `` | yes | no | `` |
| `mask_rle_stale_at_utc` | `` | yes | no | `` |
| `mask_rle_stale_component_names_json` | `` | yes | no | `` |
| `mask_rle_stale_row_count` | `` | yes | no | `` |
| `mask_rle_stale_row_min` | `` | yes | no | `` |
| `mask_rle_stale_row_max` | `` | yes | no | `` |
| `source_keypoint_group` | `` | yes | no | `` |
| `source_keypoints_run` | `` | yes | no | `` |
| `source_subject_mask_run` | `` | yes | no | `` |
| `source_subject_mask_method` | `` | yes | no | `` |
| `run_semantics` | `` | yes | no | `` |
| `probability_semantics` | `` | yes | no | `` |
| `source_background_run` | `` | yes | no | `` |
| `source_background_array` | `` | yes | no | `` |
| `source_dish_mask_array` | `` | yes | no | `` |
| `tuning_source` | `` | yes | no | `` |
| `tuning_timestamp` | `` | yes | no | `` |
| `total_rois` | `` | yes | no | `` |
| `rows_with_any_mask` | `` | yes | no | `` |
| `coverage_percent` | `` | yes | no | `` |
| `duration_seconds` | `` | yes | no | `` |
| `rois_per_second` | `` | yes | no | `` |
| `available_component_count` | `` | yes | no | `` |
| `available_components_json` | `` | yes | no | `` |
| `unavailable_components_json` | `` | yes | no | `` |
| `component_review_states_json` | `` | yes | no | `` |
| `eye_component_mode` | `` | yes | no | `` |
| `review_state` | `` | yes | no | `` |
| `review_method` | `` | yes | no | `` |
| `review_intended_use` | `` | yes | no | `` |
...
| `trait_name` | `` | yes | no | `` |
| `trait_value` | `` | yes | no | `` |
| `vocabulary_id` | `` | yes | no | `` |
| `vocabulary_version` | `` | yes | no | `` |
| `assignment_method` | `` | yes | no | `` |
| `assigned_by` | `` | yes | no | `` |
| `assigned_at_utc` | `` | yes | no | `` |
| `evidence_json` | `` | yes | no | `` |
| `created_utc` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
...
| `dataset_id` | `` | yes | no | `` |
| `species` | `` | yes | no | `` |
| `source_line_strain` | `` | yes | no | `` |
| `canonical_strain` | `` | yes | no | `` |
| `trait_name` | `` | yes | no | `` |
| `trait_value` | `` | yes | no | `` |
| `vocabulary_id` | `` | yes | no | `` |
| `vocabulary_version` | `` | yes | no | `` |
...
| `model_sha256` | `` | yes | no | `` |
| `metrics_path` | `` | yes | no | `` |
| `metrics_sha256` | `` | yes | no | `` |
| `label_schema_id` | `` | yes | no | `` |
| `coverage_class` | `` | yes | no | `` |
| `component_coverage_key` | `` | yes | no | `` |
| `mask_labels_json` | `` | yes | no | `` |
| `component_groups_json` | `` | yes | no | `` |
| `best_metric_name` | `` | yes | no | `` |
| `best_metric_value` | `` | yes | no | `` |
| `best_epoch` | `` | yes | no | `` |
| `created_utc` | `` | yes | no | `` |
| `final_metrics_json` | `` | yes | no | `` |
| `metadata_json` | `` | yes | no | `` |
...
| `recording_id` | `` | yes | no | `` |
| `zarr_use` | `` | yes | no | `` |
| `source_frame_array` | `` | yes | no | `` |
| `profile_created_utc` | `` | yes | no | `` |
| `zarr_mtime_ns` | `` | yes | no | `` |
| `updated_utc` | `` | yes | no | `` |
| `frames_total` | `` | yes | no | `` |
| `frames_profiled` | `` | yes | no | `` |
| `mean_intensity_p50` | `` | yes | no | `` |
| `contrast_p50` | `` | yes | no | `` |
| `sharpness_p50` | `` | yes | no | `` |
| `clip_dark_rate_mean` | `` | yes | no | `` |
| `clip_bright_rate_mean` | `` | yes | no | `` |
| `illumination_center_edge_p50` | `` | yes | no | `` |
| `illumination_slope_x_p50` | `` | yes | no | `` |
| `illumination_slope_y_p50` | `` | yes | no | `` |
| `fish_bg_contrast_p50` | `` | yes | no | `` |
| `rig_id` | `` | yes | no | `` |
| `camera_id` | `` | yes | no | `` |
| `arena_id` | `` | yes | no | `` |
| `dish_design` | `` | yes | no | `` |
