...
| Egocentric bearing and polar distance | Absent | Reviewed body-frame authority bound to the same acquisition-row and position-provider identities |
| Fish heading and alignment | Absent | The same reviewed body-frame authority; position-only relative-frame runs cannot support these claims |
