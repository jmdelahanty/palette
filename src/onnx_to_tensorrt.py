...
def main(args):
    ...
    if args.profiling:
        ...
        command.append(f"--exportTimes={timing_json}")
        command.append(f"--exportOutput={output_json}")
        command.append(f"--exportProfile={profile_json}")
        print(f"📊 Profiling enabled. Reports will be saved to:")
