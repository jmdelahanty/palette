...
class RecordingDetectionPostprocessInputs:
    ...
    def __post_init__(self) -> None:
        ...
        if requirement == "required" and not str(self.registered_gate_run or "").strip():
...
def build_recording_detection_postprocess_fragment(
    ...
    source_group = f"detect_runs/{inputs.source_detect_run}"
    ...
    outputs = RecordingDetectionPostprocessOutputs(
        ...
        source_detect_run=inputs.source_detect_run,
