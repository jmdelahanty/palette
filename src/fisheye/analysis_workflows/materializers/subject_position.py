...
class SubjectPositionPreparedInput:
    ...
    No detection, keypoint, or mask implementation is imported here.  The
    caller owns source interpretation and supplies exact arrays plus canonical
    records whose digests are checked before a plan can be built.
    """
    ...
    def __post_init__(self) -> None:
        ...
        if declared_descriptor_digest is not None and declared_descriptor_digest != descriptor_digest:
