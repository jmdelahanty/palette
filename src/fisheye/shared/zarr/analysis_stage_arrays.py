...
STIMULUS_RESPONSE_TRACK_INPUTS: Tuple[ArraySpec, ...] = (
    ...
    ArraySpec("angular_velocity_raw_deg_s", "float32", ("n_samples",), required=False,
              description="Raw-heading change rate in degrees/second."),
    ArraySpec("angular_speed_raw_deg_s", "float32", ("n_samples",), required=False,
              description="Unsigned raw-heading turning rate in degrees/second."),
    ArraySpec("angular_velocity_smoothed_deg_s", "float32", ("n_samples",), required=False,
              description="Smoothed-heading change rate in degrees/second."),
    ArraySpec("angular_speed_smoothed_deg_s", "float32", ("n_samples",), required=False,
              description="Unsigned smoothed-heading turning rate in degrees/second."),
