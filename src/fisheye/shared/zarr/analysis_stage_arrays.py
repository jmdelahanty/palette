...
STIMULUS_RESPONSE_TRACK_INPUTS: Tuple[ArraySpec, ...] = (
    ...
    ArraySpec("displacement_smoothed_mm", "float32", ("n_samples",), required=False,
              description="Gap-aware movement from previous frame to this sample in mm."),
    ArraySpec("cumulative_distance_mm", "float32", ("n_samples",), required=False,
              description="Cumulative gap-aware distance in mm."),
