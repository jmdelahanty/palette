    ...
    if args.log_registry:
        ...
        _record_registry_training_run(
            ...
            final_metrics={
                ...
                "best_epoch": success_summary.get("best_epoch") if success_summary else None,
                "epochs": success_summary.get("epochs") if success_summary else None,
                "train_samples": success_summary.get("train_samples") if success_summary else None,
                "val_samples": success_summary.get("val_samples") if success_summary else None,
                "label_schema_id": bundle.label_schema_id,
                "mask_labels": list(bundle.mask_labels),
