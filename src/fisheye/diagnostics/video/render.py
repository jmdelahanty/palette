    ...
    if container.status != "skip":
        lines.extend(
            [
                ...
                f"  sync_sample_semantics: {container.sync_sample_semantics or '—'}",
                f"  sync_sample_proof: {container.sync_sample_proof or '—'}",
                f"  inspection_status: {container.container_inspection_status or '—'}",
