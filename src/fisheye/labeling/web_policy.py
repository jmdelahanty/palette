...
BROWSER_WORKFLOW_CAPABILITIES: tuple[dict[str, object], ...] = (
    {
        ...
        "notes": "Mutable browser saves are durable local checkpoints; explicit Apply writes canonical keypoint surfaces. Immutable bases retain their direct delta compatibility writer.",
    },
    {
