...
STAGE_SPECS: tuple[StageSpec, ...] = (
    ...
    StageSpec(
        id="stimulus_epochs",
        depends_on=("stimulus",),
        invalidates=("detection_occupancy",),
        artifact_families=("analysis/stimulus_epoch_runs",),
        category=DERIVED_ANALYSIS,
        description="Protocol-resolved stimulus windows for aligned analyses.",
    ),
    StageSpec(
        id="detection_occupancy",
        depends_on=("refined_detect", "stimulus_epochs"),
        artifact_families=("analysis/detection_occupancy_runs",),
        category=DERIVED_ANALYSIS,
        description="Stimulus-window-aligned detection occupancy and coverage.",
    ),
    StageSpec(
        id="session_occupancy",
        depends_on=("refined_detect",),
        artifact_families=("analysis/session_occupancy_runs",),
        category=DERIVED_ANALYSIS,
