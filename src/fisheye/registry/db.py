...
from .zarr_open import (
    open_zarr_group_non_consolidated as _open_zarr_group_non_consolidated,
)
...
PIGMENT_CELL_STATUS_VALUES = frozenset({"normal", "reduced", "absent", "increased", "altered_distribution", "unknown"})
...
OPTICAL_TRANSPARENCY_VALUES = frozenset({"normal", "partially_transparent", "transparent", "unknown"})
...
def _validate_trait_assignment(
    *,
    ...
    if normalized_value not in allowed_values:
        ...
        raise ValueError(f"Unsupported {normalized_name} value {normalized_value!r}; expected one of: {allowed}.")
    if vocabulary_id is not None and str(vocabulary_id).strip() != expected_vocabulary_id:
        raise ValueError(f"{normalized_name} requires vocabulary_id={expected_vocabulary_id!r}.")
...
def resolve_dataset_id(root: zarr.Group, zarr_path: Path) -> Tuple[str, Optional[str]]:
    ...
    if not session_uuid:
        ...
        session_uuid = _decode_attr(manifest.get("session_uuid")) or _decode_attr(manifest.get("recording_id"))
    ...
    if crop_parent is not None and crop_run_name and crop_run_name in crop_parent:
        ...
        if "detection_source" in crop_group:
            ...
            if raw_source.size > 0:
                ...
                source_code_counts = {
                    str(int(code)): int(count) for code, count in zip(unique.tolist(), counts.tolist())
                }
        ...
        includes_interpolated = bool(crop_group.attrs.get("includes_interpolated", n_interpolated > 0))
...
class Registry(
    ...
    def _ensure_training_model_discovery_columns(self) -> None:
        ...
        cur = self.conn.cursor()
        cur.execute("CREATE INDEX IF NOT EXISTS idx_training_models_task_status ON training_models(task_type, status);")
        cur.execute("CREATE INDEX IF NOT EXISTS idx_training_models_label_schema ON training_models(label_schema_id);")
        cur.execute(
    ...
    def upsert_strain_trait_expectation(
        ...
        *,
        ...
        normalized_species = str(species).strip()
        normalized_canonical_strain = str(canonical_strain).strip()
        normalized_name, normalized_value, resolved_vocabulary_id = _validate_trait_assignment(
    ...
    def upsert_subject_mask_performance(
        ...
        *,
        ...
        zarr_mtime_ns: Optional[int] = None,
        updated_utc: Optional[str] = None,
        source_crop_storage_mode: Optional[str] = None,
        source_crop_signature: Optional[str] = None,
        source_crop_revision: Optional[int] = None,
        source_roi_image_representation: Optional[str] = None,
        source_roi_pixel_contract_name: Optional[str] = None,
        source_roi_pixel_contract_json: Optional[str] = None,
        source_roi_read_mode: Optional[str] = None,
        roi_cache_policy: Optional[str] = None,
        source_roi_cache_used: Optional[int] = None,
        source_roi_cache_backend: Optional[str] = None,
        source_roi_live_acceleration_effective: Optional[str] = None,
        source_roi_live_gpu_chunk_frames: Optional[int] = None,
        mask_storage_encoding: Optional[str] = None,
        mask_store_encodings_json: Optional[str] = None,
        masks_roi_materialized: Optional[int] = None,
        mask_rle_materialized: Optional[int] = None,
        mask_rle_schema_id: Optional[str] = None,
        mask_rle_encoding: Optional[str] = None,
        mask_rle_layout: Optional[str] = None,
        masks_roi_logical_bytes: Optional[int] = None,
        masks_roi_stored_bytes: Optional[int] = None,
        masks_roi_materialized_from: Optional[str] = None,
        masks_roi_materialized_at_utc: Optional[str] = None,
        mask_rle_logical_bytes: Optional[int] = None,
        mask_rle_stored_bytes: Optional[int] = None,
        mask_rle_refreshed_at_utc: Optional[str] = None,
        mask_rle_refresh_row_count: Optional[int] = None,
        mask_rle_stale: Optional[int] = None,
        mask_rle_stale_reason: Optional[str] = None,
        mask_rle_stale_at_utc: Optional[str] = None,
        mask_rle_stale_component_names_json: Optional[str] = None,
        mask_rle_stale_row_count: Optional[int] = None,
        mask_rle_stale_row_min: Optional[int] = None,
        mask_rle_stale_row_max: Optional[int] = None,
    ) -> None:
        payload = {
            "dataset_id": str(dataset_id),
            ...
            "source_roi_pixel_contract_json": source_roi_pixel_contract_json,
            ...
            "mask_storage_encoding": mask_storage_encoding,
            "mask_store_encodings_json": mask_store_encodings_json,
            "masks_roi_materialized": masks_roi_materialized,
            "mask_rle_materialized": mask_rle_materialized,
            "mask_rle_schema_id": mask_rle_schema_id,
            "mask_rle_encoding": mask_rle_encoding,
            "mask_rle_layout": mask_rle_layout,
            "masks_roi_logical_bytes": masks_roi_logical_bytes,
            "masks_roi_stored_bytes": masks_roi_stored_bytes,
            "masks_roi_materialized_from": masks_roi_materialized_from,
            "masks_roi_materialized_at_utc": masks_roi_materialized_at_utc,
            "mask_rle_logical_bytes": mask_rle_logical_bytes,
            "mask_rle_stored_bytes": mask_rle_stored_bytes,
            "mask_rle_refreshed_at_utc": mask_rle_refreshed_at_utc,
            "mask_rle_refresh_row_count": mask_rle_refresh_row_count,
            "mask_rle_stale": mask_rle_stale,
            "mask_rle_stale_reason": mask_rle_stale_reason,
            "mask_rle_stale_at_utc": mask_rle_stale_at_utc,
            "mask_rle_stale_component_names_json": mask_rle_stale_component_names_json,
            "mask_rle_stale_row_count": mask_rle_stale_row_count,
            "mask_rle_stale_row_min": mask_rle_stale_row_min,
            "mask_rle_stale_row_max": mask_rle_stale_row_max,
        ...
        self.conn.execute(
            ...
            INSERT INTO subject_mask_performance (
                ...
                source_crop_run, source_crop_storage_mode, source_crop_signature, source_crop_revision,
                ...
                mask_storage_encoding, mask_store_encodings_json, masks_roi_materialized,
                mask_rle_materialized, mask_rle_schema_id, mask_rle_encoding, mask_rle_layout,
                masks_roi_logical_bytes, masks_roi_stored_bytes,
                masks_roi_materialized_from, masks_roi_materialized_at_utc,
                mask_rle_logical_bytes, mask_rle_stored_bytes,
                mask_rle_refreshed_at_utc, mask_rle_refresh_row_count,
                mask_rle_stale, mask_rle_stale_reason, mask_rle_stale_at_utc,
                mask_rle_stale_component_names_json, mask_rle_stale_row_count,
                mask_rle_stale_row_min, mask_rle_stale_row_max,
                source_keypoint_group, source_keypoints_run,
            ...
            ON CONFLICT(dataset_id, stage_group, run_name) DO UPDATE SET
                ...
                source_crop_run=excluded.source_crop_run,
                source_crop_storage_mode=excluded.source_crop_storage_mode,
                source_crop_signature=excluded.source_crop_signature,
                source_crop_revision=excluded.source_crop_revision,
                source_roi_image_representation=excluded.source_roi_image_representation,
                source_roi_pixel_contract_name=excluded.source_roi_pixel_contract_name,
                source_roi_pixel_contract_json=excluded.source_roi_pixel_contract_json,
                source_roi_read_mode=excluded.source_roi_read_mode,
                roi_cache_policy=excluded.roi_cache_policy,
                source_roi_cache_used=excluded.source_roi_cache_used,
                source_roi_cache_backend=excluded.source_roi_cache_backend,
                source_roi_live_acceleration_effective=excluded.source_roi_live_acceleration_effective,
                source_roi_live_gpu_chunk_frames=excluded.source_roi_live_gpu_chunk_frames,
                mask_storage_encoding=excluded.mask_storage_encoding,
                mask_store_encodings_json=excluded.mask_store_encodings_json,
                masks_roi_materialized=excluded.masks_roi_materialized,
                mask_rle_materialized=excluded.mask_rle_materialized,
                mask_rle_schema_id=excluded.mask_rle_schema_id,
                mask_rle_encoding=excluded.mask_rle_encoding,
                mask_rle_layout=excluded.mask_rle_layout,
                masks_roi_logical_bytes=excluded.masks_roi_logical_bytes,
                masks_roi_stored_bytes=excluded.masks_roi_stored_bytes,
                masks_roi_materialized_from=excluded.masks_roi_materialized_from,
                masks_roi_materialized_at_utc=excluded.masks_roi_materialized_at_utc,
                mask_rle_logical_bytes=excluded.mask_rle_logical_bytes,
                mask_rle_stored_bytes=excluded.mask_rle_stored_bytes,
                mask_rle_refreshed_at_utc=excluded.mask_rle_refreshed_at_utc,
                mask_rle_refresh_row_count=excluded.mask_rle_refresh_row_count,
                mask_rle_stale=excluded.mask_rle_stale,
                mask_rle_stale_reason=excluded.mask_rle_stale_reason,
                mask_rle_stale_at_utc=excluded.mask_rle_stale_at_utc,
                mask_rle_stale_component_names_json=excluded.mask_rle_stale_component_names_json,
                mask_rle_stale_row_count=excluded.mask_rle_stale_row_count,
                mask_rle_stale_row_min=excluded.mask_rle_stale_row_min,
                mask_rle_stale_row_max=excluded.mask_rle_stale_row_max,
    ...
    def _profile_duplicate_context_write_policy(self, dataset_id: str) -> Tuple[bool, bool]:
        ...
        has_recording_context = bool(row is not None and int(row["has_recording_context"] or 0) == 1)
        has_normalized_subject_context = bool(row is not None and int(row["has_normalized_subject_context"] or 0) == 1)
    ...
    def _query_detect_review_current_view(
        ...
        *,
        ...
        if max_interpolated_detections_rate is not None:
            sql.append("AND interpolated_detections_rate IS NOT NULL AND interpolated_detections_rate <= ?")
    ...
    def _resolve_shape_fields(
        ...
        *,
        ...
        if shape_list:
            ...
            dynamic_shapes = int(any(self._int_or_none(dimension) is None for dimension in shape_list))
        ...
        *,
        ...
        if export_type_norm == "onnx":
            ...
            if metadata:
                ...
                if isinstance(raw_versions, dict):
                    plugin_versions = {
                        str(key): str(value) for key, value in raw_versions.items() if key and value is not None
                    }
                ...
                if isinstance(build_env, dict):
                    ...
                    exporter_hostname = (
                        str(build_env.get("system_hostname")) if build_env.get("system_hostname") else None
                    )
            ...
            self.record_onnx_model(
                ...
                manifest_path=manifest_path,
                manifest_sha256=(
                    str(metadata.get("manifest_sha256")) if metadata and metadata.get("manifest_sha256") else None
                ),
                opset=onnx_opset,
                nms_conf=nms_conf,
                nms_iou=nms_iou,
        ...
        if export_type_norm in {"tensorrt", "trt"}:
            ...
            if metadata:
                ...
                build_env = metadata.get("build_env")
                if isinstance(build_env, dict):
                    trt_version = str(build_env.get("tensorrt_version")) if build_env.get("tensorrt_version") else None
                    cuda_version = str(build_env.get("cuda_version")) if build_env.get("cuda_version") else None
                    system_hostname = (
                        str(build_env.get("system_hostname")) if build_env.get("system_hostname") else None
                    )
                    gpu_name = str(build_env.get("gpu_name")) if build_env.get("gpu_name") else None
    ...
    def record_onnx_model(
        ...
        *,
        ...
        plugin_versions_norm = {
            str(key): str(value) for key, value in (plugin_versions or {}).items() if key and value is not None
        }
        requires_plugins_norm = int(bool(requires_plugins)) if requires_plugins is not None else None
        payload = {
            "run_id": str(run_id),
            "set_id": str(set_id) if set_id else None,
            "skeleton_id": str(skeleton_id) if skeleton_id else None,
            ...
            "dynamic_shapes": (int(bool(dynamic_shapes)) if dynamic_shapes is not None else None),
            "file_size_bytes": self._int_or_none(file_size_bytes),
            "exporter_torch_version": (str(exporter_torch_version) if exporter_torch_version else None),
            "exporter_cuda_version": (str(exporter_cuda_version) if exporter_cuda_version else None),
            ...
            "plugin_versions_json": (_json_dumps(plugin_versions_norm) if plugin_versions_norm else None),
            "metadata_json": _json_dumps(metadata),
            "created_utc": _utc_now(),
        }
        self.conn.execute(
    ...
    def record_model_deployment_artifact(
        ...
        *,
        ...
        target_class_text = str(target_hardware_class).strip() if target_hardware_class else None
        ...
        payload = {
            ...
            "run_id": run_id_text,
            "source_onnx_run_id": (str(source_onnx_run_id).strip() if source_onnx_run_id else None),
            "source_onnx_path": str(source_onnx_path) if source_onnx_path else None,
            "source_onnx_sha256": (str(source_onnx_sha256).strip().lower() if source_onnx_sha256 else None),
            ...
            "target_compute_capability": (
                str(target_compute_capability).strip() if target_compute_capability else None
            ),
            "precision": precision_text,
            "engine_path": str(engine_path) if engine_path else None,
            "engine_sha256": (str(engine_sha256).strip().lower() if engine_sha256 else None),
            "manifest_path": str(manifest_path) if manifest_path else None,
            "manifest_sha256": (str(manifest_sha256).strip().lower() if manifest_sha256 else None),
            "status": status_text,
            ...
            "profiling_verbosity": (str(profiling_verbosity).strip() if profiling_verbosity else None),
    ...
    def query_datasets(
        ...
        *,
        ...
        if model_input is not None:
            ...
            if mode == "gray":
                sql.append("AND (COALESCE(dcc.has_images_ds, 0) = 1 OR dcc.downsample_formats_json LIKE '%\"gray\"%')")
            elif mode == "rgb":
                sql.append(
