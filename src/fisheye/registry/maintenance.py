...
def _build_recording_step_rows_from_root(
    *,
    ...
    (
        tail_kinematics_run,
        tail_kinematics_group,
        _tail_kinematics_selection,
        tail_kinematics_status,
        _tail_kinematics_reason,
        tail_kinematics_method,
        _tail_kinematics_state,
        tail_kinematics_details,
    ) = _analysis_status(
    ...
    (
        ...
        tail_posture_view_group,
        _tail_posture_view_selection,
        tail_posture_view_status,
        _tail_posture_view_reason,
        tail_posture_view_method,
        _tail_posture_view_state,
        tail_posture_view_details,
    ) = _analysis_status(
    ...
    (
        ...
        bout_classification_group,
        _bout_classification_selection,
        bout_classification_status,
        _bout_classification_reason,
        bout_classification_method,
        _bout_classification_state,
        bout_classification_details,
    ) = _analysis_status(
        "bout_classification_runs",
        prerequisites={
            "tail_posture_view": tail_posture_view_status,
    ...
    rows: List[Dict[str, object]] = [
        ...
        _make_recording_step_row(
            dataset_id=dataset_id,
            recording_id=recording_id,
            step_name="tail_kinematics",
            status=tail_kinematics_status,
            run_name=tail_kinematics_run,
            method=tail_kinematics_method,
            coverage_pct=None,
            review_status=None,
            details={**common_details, **tail_kinematics_details},
            source=source,
            zarr_mtime_ns=zarr_mtime_ns,
            updated_utc=_extract_updated_utc(tail_kinematics_group, fallback=fallback_updated_utc),
        ),
        _make_recording_step_row(
            dataset_id=dataset_id,
            recording_id=recording_id,
            step_name="tail_posture_view",
            status=tail_posture_view_status,
            run_name=tail_posture_view_run,
            method=tail_posture_view_method,
            coverage_pct=None,
            review_status=None,
            details={**common_details, **tail_posture_view_details},
            source=source,
            zarr_mtime_ns=zarr_mtime_ns,
            updated_utc=_extract_updated_utc(tail_posture_view_group, fallback=fallback_updated_utc),
        ),
        _make_recording_step_row(
            dataset_id=dataset_id,
            recording_id=recording_id,
            step_name="bout_classification",
            status=bout_classification_status,
            run_name=bout_classification_run,
            method=bout_classification_method,
            coverage_pct=None,
            review_status=None,
            details={**common_details, **bout_classification_details},
            source=source,
            zarr_mtime_ns=zarr_mtime_ns,
            updated_utc=_extract_updated_utc(bout_classification_group, fallback=fallback_updated_utc),
        ),
        _make_recording_step_row(
            dataset_id=dataset_id,
            recording_id=recording_id,
