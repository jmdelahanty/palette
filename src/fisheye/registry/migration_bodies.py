...
class RegistryMigrationMixin:
    ...
    def _migration_014_crop_quality_registry(self) -> None:
        ...
        cur.execute(
            ...
            CREATE TABLE IF NOT EXISTS crop_quality (
                ...
                crop_schema_id TEXT,
                source_pixels TEXT,
                provider_record_sha256 TEXT,
                routing_policy_id TEXT,
                crop_policy_id TEXT,
                source_acquisition_mode TEXT,
                source_acquisition_ledger_record_sha256 TEXT,
                acquisition_video_rows INTEGER,
                full_frame_recovery_rows INTEGER,
                crop_pixel_routing_ready INTEGER,
                total_rois INTEGER,
    ...
    def _migration_069_crop_pixel_routing_registry(self) -> None:
    ...
    def _migration_072_recording_identity_authority(self) -> None:
        ...
        if preexisting:
            raise RuntimeError(
                "migration 72 refuses pre-existing recording identity authority "
        ...
        cur.execute(
            ...
            CREATE TABLE IF NOT EXISTS recording_identity_revisions (
                ...
                CHECK(length(evidence_digest) = 64),
                CHECK(evidence_digest NOT GLOB '*[^0-9a-f]*'),
                CHECK(registry_schema_version >= 72)
            );
            """
        )
        cur.execute(
