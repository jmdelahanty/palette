...
_CHASER_NEAR_FIELD_SUMMARY_FIELDS = (
    ...
    + (
        ...
        _field("visit_policy_version", "string"),
        _field("near_zone_entry_rate_numerator_semantics", "string"),
        _field("near_zone_entry_rate_denominator_semantics", "string"),
        _field("near_zone_invalid_gap_policy", "string"),
        _field("near_zone_boundary_censor_policy", "string"),
        _field("pairwise_role_contrast_policy", "string"),
...
_CHASER_NEAR_FIELD_PHASE_FIELDS = (
    ...
    + (
        ...
        _field("near_zone_entry_rate_numerator_count", "int64"),
        _field("near_zone_valid_tracked_duration_s", "float64"),
        _field("near_zone_entry_rate_denominator_duration_s", "float64"),
        ...
        _field("near_zone_invalid_gap_count", "int64"),
        _field("near_zone_censor_event_count", "int64"),
        _field("near_zone_boundary_censor_event_count", "int64"),
        _field("near_zone_invalid_gap_censor_event_count", "int64"),
...
_GROUP_STATISTICS_FIELDS = (
    ...
    _field("cluster_mode", "string"),
    _field("cluster_unit", "string"),
    _field("cluster_method", "string"),
    _field("cluster_status", "string"),
    _field("cluster_reason", "string", nullable=True),
    _field("cluster_count", "int64"),
    _field("clustered_unit_count", "int64"),
    _field("clustered_mean_difference", "float64", nullable=True),
    _field("clustered_standard_error", "float64", nullable=True),
    _field("clustered_ci_low", "float64", nullable=True),
...
def arrow_contract_envelope(table_names: Sequence[str]) -> dict[str, object]:
    ...
    return contract_envelope(
        table_names,
        known_table_names=tuple(TABLE_CONTRACTS),
...
def exact_arrow_schema(table_name: str, *, metadata: Mapping[bytes, bytes]) -> Any:
    ...
    return exact_schema(ARROW_TABLE_CONTRACTS[table_name], metadata=metadata)
