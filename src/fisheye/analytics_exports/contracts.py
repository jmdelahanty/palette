...
TABLE_CONTRACTS: dict[str, TableContract] = {
    ...
    CHASER_EPOCH_BEHAVIOR_TABLE: _contract(
        ...
        ),
        {
            ...
            "valid_tracked_duration_s": "s",
            "bout_rate_denominator_s": "s",
            "inter_bout_interval_rate_denominator_s": "s",
        },
    ),
    ...
    CHASER_NEAR_FIELD_OCCUPANCY_SUMMARY_TABLE: _contract(
        ...
        (
            ...
            "near_zone_entry_rate_numerator_semantics",
            "near_zone_entry_rate_denominator_semantics",
            "near_zone_invalid_gap_policy",
            "near_zone_boundary_censor_policy",
            "pairwise_role_contrast_policy",
        ),
    ),
    CHASER_NEAR_FIELD_OCCUPANCY_CHASER_PHASE_TABLE: _contract(
        ...
        ),
        {
            "approach_p05_mm": "mm",
            "approach_p10_mm": "mm",
            "near_zone_entry_rate_numerator_count": "count",
            "near_zone_valid_tracked_duration_s": "s",
            "near_zone_entry_rate_denominator_duration_s": "s",
            "near_zone_entry_rate_per_min": "1/min",
            "near_zone_invalid_gap_count": "count",
            "near_zone_censor_event_count": "count",
            "near_zone_boundary_censor_event_count": "count",
            "near_zone_invalid_gap_censor_event_count": "count",
        },
    ),
